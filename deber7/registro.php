...
echo'<td><div class="input-container">';
echo'<input name="email1" id="email1" type="text" />
        </div></td>';
echo'</tr>';
echo'<tr>';

echo'<td><label for="email">Vuelva a escribir su correo electrónico:</label></td>';
echo'<td><div class="input-container">';
echo'<input name="email2" id="email2" type="text" />
        </div></td>';
